...
import {
    Accordion,AccordionContent,AccordionHeader,AccordionItem} from './Accordian'
const ScoreBadge =({score})=>{
    return(
        ...
        score>69 ? "bg-badge-green" : score>39 ? "bg-badge-yellow":"bg-badge-red")}>
            ...
            <p className={cn("text-sm font-medium",score>69? "text-badge-green": score>39 ?"text-badge-yellow-text" :"text-badge-red-text")}>
                {score}/100
            </p>
        </div>
    )
